...
playlist. Radio favorites do not reserve a star column in playlists containing
no favorited stations. They are saved locally in `~/.config/cliamp/radio_favorites.toml`,
